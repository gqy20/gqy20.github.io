...
### 4.3 流派 B:结构化推理派(代表:GraphRAG / LightRAG)
...
> 💡 **实战建议**:重排(Rerank)是被严重低估的杠杆——它只需一个 API 调用(Cohere Rerank / BGE-Reranker),就能稳定带来 10~30% 的相关性提升,是**投入产出比最高的降幻觉优化**。如果你的知识库没有 Rerank,优先补上。

### 4.5 框架派速览:Haystack / LlamaIndex / txtai / Pathway
...
*本文调研截止至 2026 年 6 月,项目 Star 数、协议和功能可能随时间变化,建议在做最终决策前再次确认最新版本。降幻觉与实测数据来自 ACL 2025 论文、arXiv 2502.11371 系统评测、Tailored AI、NVIDIA GraphRAG 实测、AWS Strands 对比实验及 Onyx / Univeris 企业案例。*
